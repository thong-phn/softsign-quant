...
def main():
    ...
    for val_subject in all_train_subjects:
        ...
        original_model = SeparableConvCNN(num_classes=num_classes, num_channels=num_channels, use_quant=use_quant, per_channel_quant=per_channel_quant)
    ...
    with open("wear_quantize_loso_results.log", "w") as f:
