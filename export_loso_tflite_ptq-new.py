...
def _make_dataset(
    ...
    if dataset_name == "mhealth":
        ...
        return MHealthDataset(root_path, subject_ids=subject_ids)

    if dataset_name == "recgym":
        return RecGymDataset(root_path, subject_ids=subject_ids)

    if dataset_name == "realworld":
        return RealworldDataset(root_path, subject_ids=subject_ids)
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="wear",
        choices=["wear", "uci-har", "mhealth", "recgym", "realworld"],
